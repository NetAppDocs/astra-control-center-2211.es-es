...
Visite la https://github.com/NetApp/Verda["Proyecto Verda GitHub de NetApp"] para ver ejemplos y tener una idea de cómo estructurar los ganchos de ejecución. Puede utilizar estos ejemplos como plantillas o scripts de prueba.
